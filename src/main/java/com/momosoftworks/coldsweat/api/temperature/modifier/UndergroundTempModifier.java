    ...
    public Function<Double, Double> calculate(LivingEntity entity, Temperature.Trait trait)
    {
        ...
        for (BlockPos pos : WorldHelper.getPositionCube(entity.blockPosition(), 5, 10))
        {
            ...
            if (holder.is(Tags.Biomes.IS_UNDERGROUND))
            {
                ...
                BiomeTempData configTemp = ConfigSettings.BIOME_TEMPS.get(entity.registryAccess())
                                      .getOrDefault(biome, new BiomeTempData(biome, baseTemp, baseTemp, Temperature.Units.MC));
                BiomeTempData configOffset = ConfigSettings.BIOME_OFFSETS.get(entity.registryAccess())
